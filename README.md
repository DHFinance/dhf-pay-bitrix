...
* Video examples of using the invoicing module: This is an introductory video, guiding the process of creating invoices on Bitrix24 and paying with CSPR via DHFinance payment gateway [here](https://www.youtube.com/watch?v=vODM4Ghqz5A)
